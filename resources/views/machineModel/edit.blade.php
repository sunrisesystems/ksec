		...
		<div class="row">
			<div class="col-lg-12 col-md-12">
				<ol class="breadcrumb">
					...
					<li class="active">
						<strong>Edit Machine Model</strong>
					</li>					
				</ol>
			</div>
		</div>
	...
	<div class="pageHeading container-fluid">
		<div class="row ">			
			<div class="page-title-wrapper">			
				<div class="col-lg-12">
					<h2 class="page-header">Edit Machine Model</h2>					
				</div>							
			</div>			
		</div>
	</div><!-- pageHeading end -->
		...
		<div class="row">
			<div class="col-xs-12">
				<section id="groupDetail" class="form-container">
						{!! Form::model($machineModel, array('method' => 'PATCH', 'route' => array('machineModel.update', $machineModel->id),'name'=>'frm','onsubmit'=>' return validateMachineModel()')) !!}
