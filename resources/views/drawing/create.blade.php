	...
	<div class="pageHeading container-fluid">
		<div class="row ">			
			<div class="page-title-wrapper">			
				<div class="col-lg-12">
					<h2 class="page-header">Add Drawing</h2>					
				</div>							
			</div>			
		</div>
	</div><!-- pageHeading end -->
    <div class="main-container-inner container-fluid">
        <div class="row">
          <div class="col-xs-12">
			...
			{!! Form::open(array('route' => 'drawings.store' , 'onSubmit' => 'return validateCategory()','files'=>true)) !!}
				<div class="form-control-wrapper" >
					...
					<div class="form-group">
						<div class="row">
							<div class="col-sm-4"> 
								{!! HTML::decode( Form::label('partial_mold_changeover_b', 'Partial Mold Changeover (B) (hrs)<small class="mandatory">*</small>')) !!}
