...
<div id="main-container" class="main-container">
	...
	<div class="searchForm " style="display:none;">
		...
		{!! Form::open(array('route' => 'product-category.index','method'=>'GET','onSubmit' => 'return validateSearch()')) !!}
		<div class="form-control-wrapper">
			...
			<div class="form-group action">
				<div class="col-lg-12 pull-center buttons"> 
					...
					<button type="button" class="btn btn-black" onclick="doCancel('{!! URL::to('product-cateogry') !!}')">Cancel</button>
				</div>									
			</div><!-- action end -->
			...
			<div class="page-title-wrapper">			
				...
				<div class="col-lg-4">
					<div class="title-action">
						<a title="Add Category" class="btn btn-white add-shape add-icons" href="{!! route('product-category.create')!!}">
			...
			<div class="col-xs-12">
				...
				<div class="table-responsive">
					<table id="drawingList" class="category table table-hover">
					  ...
					  <?php $count = ($productCategories->currentPage() * Config::get('global_vars.PAGINATION_LIMIT')) - Config::get('global_vars.PAGINATION_LIMIT') + 1;
					  ?>
						<tbody>
							@foreach($productCategories as $key)
							
							<tr>
								<td align="right">{!! $count++ !!}</td>
								<td>{!! $key->name !!}</td>
								<td>{!! $data['products'][$key->product_id] !!}</td>
								...
								<td align="center" class="action-icon">								
									<a href="{!! URL::to('product-category/'.$key->id.'/edit') !!}" data-toggle="tooltip" data-placement="bottom" title="Edit Category" class="space">
