		...
		<div class="row">
			<div class="col-xs-12">
				<section id="inputDetail" class="form-container">
					{!! Form::model($productCategory, array('method' => 'PATCH', 'route' => array('product-category.update', $productCategory->id),'name'=>'frm','onsubmit'=>' return validateProductCategory()')) !!}
						<div class="form-control-wrapper">
							<div class="form-group">
								<div class="row">
									<div class="col-sm-4"> 						
										{!! HTML::decode( Form::label('name', 'Name <small class="mandatory">*</small>')) !!}
										{!! Form::text('name',$productCategory->name,array('placeholder'=>'Product Category Name','id'=>'name','class'=>'form-control')) !!}
									...
									<div class="col-sm-4">											
										...
										{!! Form::select('product',$data['products'],$productCategory->product_id,['id'=>'product','class'=>'form-control']) !!}
									...
									<div class="col-sm-4">											
										...
										{!! Form::select('status',$data['status'],$productCategory->status,['id'=>'status','class'=>'form-control']) !!}
							...
							<div class="form-group">
								<div class="row">
									<div class="col-sm-12"> 
										...
										{!! Form::textarea('description',$productCategory->description,['placeholder'=>'Description','id'=>'description','size' => '30x5','class'=>'form-control']) !!}
