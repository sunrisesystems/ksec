		...
		<div class="row">
			<div class="col-xs-12">
				<section id="inputDetail" class="form-container">
					{!! Form::open(array('route' => 'product-subcategory.store' , 'onSubmit' => 'return validateProductSubcategory()')) !!}
						<div class="form-control-wrapper">
							<div class="form-group">
								<div class="row">
									<div class="col-sm-4"> 						
										{!! HTML::decode( Form::label('name', 'Name <small class="mandatory">*</small>')) !!}
										{!! Form::text('name','',array('placeholder'=>'Product Subcategory Name','id'=>'name','class'=>'form-control')) !!}
									...
									<div class="col-sm-4">											
										...
										{!! Form::select('productCategory',$data['productCategory'],null,['id'=>'productCategory','class'=>'form-control']) !!}
