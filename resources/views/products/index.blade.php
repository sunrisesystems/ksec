			...
			<div class="page-title-wrapper">			
				...
				<div class="col-lg-4">
					<div class="title-action">
						<a title="Add Product" class="btn btn-white add-shape add-icons" href="{!! route('products.create')!!}">
					...
					<table id="drawingList" class="category table table-hover">
					  ...
					  ?>
						<tbody>
							...
							<?php $arr = [];
								if(count($key->productDepartment)){
									foreach ($key->productDepartment as $key1 => $value1) {
										if(count($value1->departments)){
											$arr[] = $value1->departments->name;
							...
							<tr>
								...
								<td align="center" class="action-icon">								
									<a href="{!! URL::to('products/'.$key->id.'/edit') !!}" data-toggle="tooltip" data-placement="bottom" title="Edit Product" class="space">
