		...
		<div class="row">
			<div class="col-xs-12">
				<section id="inputDetail" class="form-container">
					{!! Form::open(array('route' => 'products.store' , 'onSubmit' => 'return validateProduct()')) !!}
						<div class="form-control-wrapper">
							<div class="form-group">
								<div class="row">
									<div class="col-sm-3"> 						
										{!! HTML::decode( Form::label('productName', 'Name <small class="mandatory">*</small>')) !!}
										{!! Form::text('productName','',array('placeholder'=>'Product Name','id'=>'productName','class'=>'form-control')) !!}
									...
									<div class="col-sm-3"> 
										...
										{!! Form::select('department[]',$data['department'],null,['id'=>'department','class'=>'form-control','multiple'=>'multiple','size'=>5]) !!}
									...
									<div class="col-sm-3"> 
										...
										{!! Form::select('employee[]',$data['employee'],null,['id'=>'employee','class'=>'form-control','multiple'=>'multiple','size'=>5]) !!}
