...
@section('content')
<?php $unitId = Sentinel::getUser()->unit_id;?>
	...
	<div class="pageHeading container-fluid">
		<div class="row ">			
			<div class="page-title-wrapper">			
				<div class="col-lg-12">
					<h2 class="page-header">Add Mold</h2>					
				</div>							
			</div>			
		</div>
	</div><!-- pageHeading end -->
						...
						<div class="form-control-wrapper">
							...
							<div class="form-group">
								<div class="row">
									<div class="col-sm-4"> 						
										...
										{!! Form::select('unit_id',$data['unit'],$unitId,['id'=>'unit_id','class'=>'form-control']) !!}
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-sm-4 ddl"> 
										{!! HTML::decode(Form::label('bold_mold', 'Blow Mold<small class="mandatory">*</small>')) !!}
...
<script type="text/javascript">
 ...
 function redirectUrl () {
    ...
    $("#hot_runner_capacity_l, #hot_runner_capacity_c,#hot_runner_capacity_h, #mold_temp_control_zone_l,#mold_temp_control_zone_c,#mold_temp_control_zone_h,#weighted_avg_wt").ForceNumericOnly();
</script>
@stop 