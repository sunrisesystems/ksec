...
<div id="main-container" class="main-container ">
		...
		<div class="row">
			<div class="col-lg-10 col-md-10">
				<ol class="breadcrumb">
					...
					<li class="active">
						<strong>Manage Manufacturer</strong>
					</li>				
				</ol>
			</div>
	...
	<div class="searchForm" style="display:none">
		<div class="container-fluid">
			...
			{!! Form::open(array('route' => 'accounts.index','method'=>'GET','onSubmit' => 'return validateSearch()')) !!}
				<div class="form-control-wrapper">
					<div class="form-group">
						<div class="row">
							<div class="col-sm-4"> 
								{!! Form::label('Name', 'Manufacturer Name') !!}
								{!! Form::text('name',Request::get('name'),array("placeholder"=>"Manufacturer Name",'id'=>'name','class'=>'form-control')) !!}
					...
					<div class="form-group action">
						<div class="col-lg-12 pull-center buttons"> 
							...
							<button type="button" class="btn btn-black" onclick="doCancel('{!! URL::to('accounts') !!}')">Cancel</button>
						</div>									
					</div><!-- action end -->
	...
	<div class="pageHeading container-fluid">
		<div class="row ">			
			<div class="page-title-wrapper">			
				<div class="col-lg-8">
					<h2 class="page-header">Manage Manufacturer</h2>					
				</div>
				<div class="col-lg-4">
					<div class="title-action">
						<a title="Add Manufacturer" class="btn btn-white add-account add-icons" href="{!! route('accounts.create')!!}">
							<i class="glyphicon glyphicon-plus"></i> Add Manufacturer
						</a>
			...
			<div class="col-xs-12">
				...
				<div class="table-responsive">
					<table id="drawingList" class="category table table-hover">
						...
						<?php $count= ($accounts->currentPage() * Config::get('global_vars.PAGINATION_LIMIT')) - Config::get('global_vars.PAGINATION_LIMIT') + 1; ?>
						...
						<tbody>
							<tr>
								...
								<td align="center" class="action-icon">
									<a href="{!! URL::to('accounts/'.$key->id.'/edit') !!}" class="space"> 
										<i class="glyphicon glyphicon-pencil"></i>
									</a>
									{!! Form::open(array('id'=>'destroyAccount'.$key->id,'method' => 'DELETE','class'=>'delete-icon', 'route' => array('accounts.destroy', $key->id))) !!}
...
function confirmDelete(id) {
    jConfirm('<?php echo Lang::get('messages.CONFIRM_DELETE'); ?>'+" this account?", '', function(r) {
        if (r) {
    		$('#destroyAccount'+id).submit();
        }
    });
}
</script>
