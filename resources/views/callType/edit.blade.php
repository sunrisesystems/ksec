		...
		<div class="row">
			<div class="col-lg-12 col-md-12">
				<ol class="breadcrumb">
					...
					<li>
						<a href="{!! URL::to('calltype') !!}">Manage Call Type</a>
					</li>
					<li class="active">
						<strong>Edit Call Type</strong>
					</li>					
				</ol>
			</div>
		</div>
	...
	<div class="pageHeading container-fluid">
		<div class="row ">			
			<div class="page-title-wrapper">			
				<div class="col-lg-12">
					<h2 class="page-header">Edit Call Type</h2>					
				</div>							
			</div>			
		</div>
	</div><!-- pageHeading end -->
		...
		<div class="row">
			<div class="col-xs-12">
				<section id="inputDetail" class="form-container">
					{!! Form::model($callType, array('method' => 'PATCH', 'route' => array('calltype.update', $callType->id),'name'=>'frm','onsubmit'=>' return validateCallType()')) !!}
						<div class="form-control-wrapper">
							<div class="form-group">
								<div class="row">
									<div class="col-sm-4"> 						
										{!! HTML::decode( Form::label('callType', 'Name <small class="mandatory">*</small>')) !!}
										{!! Form::text('callType',$callType->call_type,array('placeholder'=>'Call Type','id'=>'callType','class'=>'form-control')) !!}
									...
									<div class="col-sm-4">											
										...
										{!! Form::select('status',$data['status'],$callType->status,['id'=>'status','class'=>'form-control']) !!}
									...
									<div class="col-sm-4"> 
										...
										{!! Form::textarea('description',$callType->description,['placeholder'=>'Description','id'=>'description','size' => '30x5','class'=>'form-control']) !!}
...
<script type="text/javascript">
     function validateCallType()
    {
        ...
        arrElemId[i]    = 'callType';
        arrCode[i]      = 'IS_EMPTY';
        arrRefValue[i]  = null;
        arrMsg[i]       = '<?php echo Lang::get("messages.empty_callType")?>';
        i++;
