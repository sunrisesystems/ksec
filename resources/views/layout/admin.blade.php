		...
		<aside class="navigation">
			<nav>
				<ul class="nav metismenu" id="side-menu">					
                    ...
                    <li <?php if($currentCA == 'voice_index' || $currentCA == 'voice_create' || $currentCA == 'voice_edit') { ?> class="dropdown active" <?php }  else {?> class="dropdown" <?php }?> >
						<a href="javascript::void(0)" ><i class="icon-left fa fa-th-large"></i> Service Quality <i class="fa fa-angle-right"></i></a>						
						<ul class="nav nav-second-level ">												
							<li <?php if($currentCA == 'voice_index' || $currentCA == 'voice_create' || $currentCA == 'voice_edit') { ?> class="active" <?php } ?>>
