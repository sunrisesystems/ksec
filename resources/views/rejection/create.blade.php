		...
		<div class="row">
			<div class="col-lg-12 col-md-12">
				<ol class="breadcrumb">
					...
					<li>
						<a href="{!!URL::to('rejection')!!}">Manage Rejection Slip</a>
					</li>
					<li class="active">
						<strong>Add/Edit Rejection Slip</strong>
					</li>					
				</ol>
			</div>
		</div>
	...
	<div class="pageHeading container-fluid">
		<div class="row ">			
			<div class="page-title-wrapper">			
				<div class="col-lg-12">
					<h2 class="page-header">Add/Edit Rejection Slip</h2>					
				</div>							
			</div>			
		</div>
	</div><!-- pageHeading end -->
    <div class="main-container-inner container-fluid">
		...
		<div class="row">
			<div class="col-xs-12">
						...
						<div class="form-control-wrapper" >
							...
							<div class="form-group action">
								<div class="col-lg-12 pull-center buttons"> 
									{!! Form::button('Submit', array('class' => 'btn btn-red','onclick'=>"return loadRejectionSlip();",'id'=>'saveButton')) !!} 
				...
				<section id="rejectionSlip" class="form-container container-fluid">
...
<script type="text/javascript">
    function loadRejectionSlip()
    {
        ...
        if(result){
        	...
        	$.ajax({
                url : base_url+"/rejection/load-rejection-slip",
                method : "POST",
