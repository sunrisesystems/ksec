	...
	<div class="pageHeading container-fluid">
		<div class="row ">			
			<div class="page-title-wrapper">			
				<div class="col-lg-12">
					<h2 class="page-header">Edit Defect</h2>					
				</div>							
			</div>			
		</div>
	</div><!-- pageHeading end -->
		...
		<div class="row">
			<div class="col-xs-12">
				<section id="inputDetail" class="form-container">
                    {!! Form::model($defect, array('method' => 'PATCH', 'route' => array('defect.update', $defect->id),'name'=>'frm','onsubmit'=>' return validateDefect()')) !!}
							...
							<div class="form-group action">
								<div class="col-lg-12 pull-center buttons"> 
									{!! Form::submit('Update', array('class' => 'btn btn-red')) !!}
