	...
	<div class="pageHeading container-fluid">
		<div class="row ">			
			<div class="page-title-wrapper">			
				<div class="col-lg-8">
					<h2 class="page-header">Manage FG Invert</h2>					
				</div>
				<div class="col-lg-4">
					<div class="title-action">
						<a title="Add User" class="btn btn-white add-user" href="{!! URL::to('invert/create')!!}">
							<i class="glyphicon glyphicon-plus"></i> Add/Edit FG Invert
						</a>
					  ...
					  ?>
						...
						@foreach($invertData->getListDTO() as $key)					
							<tr>
								...
								<td align="">{!! $key->getUpdatedTime() !!}</td>							
							</tr>
							@endforeach												
						</tbody>
				  </table><!-- table end -->
