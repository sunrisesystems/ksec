		...
		<div class="row">
			<div class="col-xs-12">
				<section id="inputDetail" class="form-container">
					{!! Form::open(array('route' => 'item.store' , 'onSubmit' => 'return validateItem()')) !!}
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
    	<?php if(!empty($errors->toArray())) { ?>
    		var groupId = '{!! old("group_id") !!}';
    		var typeId = '{!! old("type_id") !!}';
    		getType(groupId,typeId);
    	<?php } ?>
    });
</script>
@stop