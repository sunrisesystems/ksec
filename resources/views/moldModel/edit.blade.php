			...
			<div class="row">
				<div class="col-xs-12">
					<div class="page-title-wrapper">
						<h1 class="page-header">Edit Mold</h1>
					</div>
				</div>
			</div><!-- end Heading row -->
									...
									<div class="row">
										<div class="col-sm-4">											
											...
											<div class="input-group">
												...
												<a class="input-group-addon icon-wrap-red" href="javascript:void(0)" onclick="generateMoldName()">
										...
										<div class="col-sm-4">	
											...
											{!! Form::text('mold_trade_name',null,array('placeholder'=>'Mold Trade Name','id'=>'mold_trade_name','class'=>'form-control')) !!}
								...
								<div class="form-group">
									<div class="row">
										<div class="col-sm-4"> 						
											...
											{!! Form::select('drawing_id',$data['drawing'],null,['id'=>'drawing_id','onchange'=>'getMoldTradeName(this.value)','class'=>'form-control']) !!}
									...
									<div class="row">
										...
										<div class="col-md-4 col-sm-4">					
											<div class="triple-gp-wraper">					
												<div class="row">								
													<div class="col-md-12 col-sm-12">
														{!! HTML::decode( Form::label('standard_purging', 'Standard Purging % <small class="mandatory">*</small>')) !!}
													</div>
													<div class="col-sm-4">						
														{!! Form::text('std_purging_l',null,array('placeholder'=>'Low','id'=>'std_purging_l','class'=>'form-control')) !!}
														<div id="std_purging_l_alert" class="error validationAlert validationError">{!! $errors->first('std_purging_l') !!}</div> 
													</div>
													<div class="col-sm-4">					
														{!! Form::text('std_purging_c',null,array('placeholder'=>'Center','id'=>'std_purging_c','class'=>'form-control')) !!}
														<div id="std_purging_c_alert" class="error validationAlert validationError">{!! $errors->first('std_purging_c') !!}</div>
													</div>
													<div class="col-sm-4">						
														{!! Form::text('std_purging_h',null,array('placeholder'=>'High','id'=>'std_purging_h','class'=>'form-control')) !!}
										...
										<div class="col-md-4 col-sm-4">					
											<div class="triple-gp-wraper">					
												<div class="row">								
													...
													<div class="col-sm-4">						
														{!! Form::text('hot_runner_type_l',null,array('placeholder'=>'Low','id'=>'hot_runner_type_l','class'=>'form-control')) !!}
														<div id="hot_runner_type_l_alert" class="error validationAlert validationError">{!! $errors->first('hot_runner_type_l') !!}</div> 
													</div>
													<div class="col-sm-4">					
														{!! Form::text('hot_runner_type_c',null,array('placeholder'=>'Center','id'=>'hot_runner_type_c','class'=>'form-control')) !!}
														<div id="hot_runner_type_c_alert" class="error validationAlert validationError">{!! $errors->first('hot_runner_type_c') !!}</div> 
													</div>
													<div class="col-sm-4">						
														{!! Form::text('hot_runner_type_h',null,array('placeholder'=>'High','id'=>'hot_runner_type_h','class'=>'form-control')) !!}
														<div id="hot_runner_type_h_alert" class="error validationAlert validationError">{!! $errors->first('hot_runner_type_h') !!}</div> 
													</div>	
												</div> 	
											</div>
										</div>
									...
									<div class="row">
										<div class="col-md-4 col-sm-4">					
											<div class="triple-gp-wraper">					
												<div class="row">								
													...
													<div class="col-sm-4">						
														{!! Form::text('mold_temp_control_zone_l',null,array('placeholder'=>'Low','id'=>'mold_temp_control_zone_l','class'=>'form-control')) !!}
													...
													<div class="col-sm-4">					
														{!! Form::text('mold_temp_control_zone_c',null,array('placeholder'=>'Center','id'=>'mold_temp_control_zone_c','class'=>'form-control')) !!}
													...
													<div class="col-sm-4">						
														{!! Form::text('mold_temp_control_zone_h',null,array('placeholder'=>'High','id'=>'mold_temp_control_zone_h','class'=>'form-control')) !!}
										...
										<div class="col-md-4 col-sm-4">					
											<div class="triple-gp-wraper">					
												<div class="row">								
													<div class="col-md-12 col-sm-12">
														{!! HTML::decode( Form::label('standard_rejection', 'Standard Rejection %<small class="mandatory">*</small>')) !!}
													</div>
													<div class="col-sm-4">						
														{!! Form::text('std_rejection_l',null,array('placeholder'=>'Low','id'=>'std_rejection_l','class'=>'form-control')) !!}
														<div id="std_rejection_l_alert" class="error validationAlert validationError">{!! $errors->first('std_rejection_l') !!}</div>
													</div>
													<div class="col-sm-4">					
														{!! Form::text('std_rejection_c',null,array('placeholder'=>'Center','id'=>'std_rejection_c','class'=>'form-control')) !!}
														<div id="std_rejection_c_alert" class="error validationAlert validationError">{!! $errors->first('std_rejection_c') !!}</div> 
													</div>
													<div class="col-sm-4">						
														{!! Form::text('std_rejection_h',null,array('placeholder'=>'High','id'=>'std_rejection_h','class'=>'form-control')) !!}
