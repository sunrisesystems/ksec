	...
	<div class="searchForm " style="display:none;">
		<div class="container-fluid">
			<div class="form-container">
				{!! Form::open(array('route' => 'stores.index','method'=>'GET','onSubmit' => 'return validateSearch()')) !!}
				<div class="form-control-wrapper">
					<div class="form-group">
						<div class="row">
							<div class="col-sm-4"> 		
								{!! Form::label('Store', 'Store') !!}
								{!! Form::text('store',Request::get('store'),array("placeholder"=>"Store Name",'id'=>'store','class'=>'form-control')) !!} 
							</div>					
							<div class="col-sm-4">											
					...
					<div class="form-group action">
						<div class="col-lg-12 pull-center buttons"> 
							...
							<button type="button" class="btn btn-black" onclick="doCancel('{!! URL::to('stores') !!}')">Cancel</button>
						</div>									
					</div><!-- action end -->
	...
	<div class="pageHeading container-fluid">
		<div class="row ">			
			<div class="page-title-wrapper">			
				<div class="col-lg-8">
					<h2 class="page-header">Manage Stores</h2>					
				</div>
				<div class="col-lg-4">
					<div class="title-action">
						<a title="Add Store" class="btn btn-white add-store add-icons" href="{!! route('stores.create')!!}">
			...
			<div class="col-xs-12">
				...
				<div class="table-responsive">
					<table id="drawingList" class="category table table-hover">
						...
						<?php $count= ($stores->currentPage() * Config::get('global_vars.PAGINATION_LIMIT')) - Config::get('global_vars.PAGINATION_LIMIT') + 1;
							  ?>
						...
						<tbody>
							<tr>
								...
								<td align="center" class="action-icon">								
									...
									<a href="{!! URL::to('stores/'.$key->id.'/edit') !!}" class="space"> 
										<i class="glyphicon glyphicon-pencil"></i>
									</a>
									{!! Form::open(array('id'=>'destroyStore'.$key->id,'method' => 'DELETE','class'=>'delete-icon', 'route' => array('stores.destroy', $key->id))) !!}	
...
function confirmDelete(id) {
    jConfirm('<?php echo Lang::get('messages.CONFIRM_DELETE'); ?>'+" this store?", '', function(r) {
        if (r) {
    		$('#destroyStore'+id).submit();
        }
    });
}
</script>
