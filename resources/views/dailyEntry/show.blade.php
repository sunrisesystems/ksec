		...
		<div class="row">
			<div class="col-lg-12 col-md-12">
				<ol class="breadcrumb">
					...
					<li>
						<a href="{!!URL::to('dailyEntry')!!}">Manage Daily Entry</a>
					</li>
					<li class="active">
						<strong>View Daily Entry</strong>
					</li>					
				</ol>
			</div>
		</div>
	...
	<div class="pageHeading container-fluid">
		<div class="row ">			
			<div class="page-title-wrapper">			
				<div class="col-lg-12">
					<h2 class="page-header">View Daily Entry</h2>					
				</div>							
			</div>			
		</div>
	</div><!-- pageHeading end -->
    <div class="main-container-inner container-fluid">
		...
		<div class="row">
			<div class="col-xs-12">
						...
						<div class="form-control-wrapper" >
							...
							<div class="form-group action">
								<div class="col-lg-12 pull-center buttons"> 
									{!! Form::button('Submit', array('class' => 'btn btn-red','onclick'=>"return loadAllMachine();",'id'=>'saveButton')) !!} 
				...
				<section id="showMachineDetails" class="form-container container-fluid">
...
<script type="text/javascript">
    function loadAllMachine()
    {
        ...
        if(result){
        	...
        	$.ajax({
                url : base_url+"/getDailyEntryDetails",
                method : "POST",
                data : { 'date' : date,'shift':shift },
                cache : false,
                beforeSend : function(){
                	$("#showMachineDetails").html('');
                    $("#savingButton").show();
                    $("#saveButton").hide();
                },
                success:function(data){
                    $("#showMachineDetails").html(data);
                    $("#savingButton").hide();
                    $("#saveButton").show();
                },
                done : function (data){
