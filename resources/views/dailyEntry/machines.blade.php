			...
			<table class="table table-bordered">
				<thead>
					<tr>
						...
						<th width="9%">Shot Counter<small class="mandatory"> *</small></th>
						<th width="13%">Shot Counter timer<small class="mandatory"> *</small></th>
						...
						<th width="5%">Total <i class="glyphicon glyphicon-warning-sign"></i></th>
						<th width="7%">Total <i class="glyphicon glyphicon-thumbs-down"></i><small class="mandatory"> *</small></th>
						<th width="3%"><i class="glyphicon glyphicon-ok" ></i></th>
						<?php if(! $readOnly) {?>
				...
				<tbody>
					...
					<tr>
						<td>{!! ++$count !!}</td>
						<td>
						<span>{{ $key['machine'] }}</span>
						{!! Form::hidden("machine[".$key['id']."]",$key['machine'],array('class' => 'form-control','placeholder'=>'Machine','id'=>'machine','readonly'=>true)) !!}
						<div id="machine_alert" class="error validationAlert validationError">{!!$errors->first('machine')!!}</div>
						</td>
						<td>
						<span>{{ $key['product'] }}</span>
						{!! Form::hidden("product[".$key['id']."]",$key['product'],array('class' => 'form-control','placeholder'=>'Product','id'=>'product','readonly'=>true)) !!}
