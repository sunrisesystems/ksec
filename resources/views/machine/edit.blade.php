    ...
    <div class="pageHeading container-fluid">
        <div class="row ">          
            <div class="page-title-wrapper">            
                <div class="col-lg-12">
                    <h2 class="page-header">Edit Machine</h2>                    
                </div>                          
            </div>          
        </div>
    </div><!-- pageHeading end -->
        ...
        <div class="row">
            <div class="col-xs-12">
                <section id="inputDetail" class="form-container">
                    {!! Form::model($machine, array('method' => 'PATCH', 'route' => array('machine.update', $machine->id),'name'=>'frm','onsubmit'=>' return validateMachine()')) !!}
