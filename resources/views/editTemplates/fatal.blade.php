            ...
            <div class="row">
               <div class="col-lg-4 col-md-4">
                  <div class="form-group">
                     ...
                     {!! Form::select('fatalReason1',$data['fatalReason'],@$voice->sqFatal->reason1_id,['id'=>'fatalReason1','class'=>'form-control','onchange'=>'checkFatal()']) !!}
               ...
               <div class="col-lg-4 col-md-4">
                  <div class="form-group">
                     ...
                     {!! Form::select('fatalReason2',$data['fatalReason'],@$voice->sqFatal->reason2_id,['id'=>'fatalReason2','class'=>'form-control','onchange'=>'checkFatal()']) !!}
               ...
               <div class="col-lg-4 col-md-4">
                  <div class="form-group">
                     ...
                     {!! Form::textarea('fatalComment',@$voice->sqFatal->comment,['placeholder'=>'Comment','id'=>'fatalComment','size' => '30x3','class'=>'form-control']) !!}
