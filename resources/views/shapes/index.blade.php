...
<div id="main-container" class="main-container">
	...
	<div class="searchForm " style="display:none;">
		...
		{!! Form::open(array('route' => 'shapes.index','method'=>'GET','onSubmit' => 'return validateSearch()')) !!}
	...
	<div class="pageHeading container-fluid">
		<div class="row ">			
			<div class="page-title-wrapper">			
				<div class="col-lg-8">
					<h2 class="page-header">Manage Shapes</h2>					
				</div>
				<div class="col-lg-4">
					<div class="title-action">
						<a title="Add Category" class="btn btn-white add-shape add-icons" href="{!! route('shapes.create')!!}">
							<i class="glyphicon glyphicon-plus"></i> Add Shape
						</a>
				...
				<div class="table-responsive">
					<table id="drawingList" class="category table table-hover">
						<thead>
							<tr>
								<th class="right">#</th>
								<th align="left">Shape Name</th>
								<th align="left">Shape Code</th>        
								<th class="center">Status</th>
								<th class="center">Actions</th>
							</tr>
						</thead>
					  <?php $count = ($shapes->currentPage() * Config::get('global_vars.PAGINATION_LIMIT')) - Config::get('global_vars.PAGINATION_LIMIT') + 1;
					  ?>
						<tbody>
							@foreach($shapes as $key)
							<tr>
								<td align="right">{!! $count++ !!}</td>
								<td>{!! $key->shape_name !!}</td>
								<td>{!! $key->shape_code !!}</td>
								...
								<td align="center" class="action-icon">								
									<a href="{!! URL::to('shapes/'.$key->id.'/edit') !!}" data-toggle="tooltip" data-placement="bottom" title="Edit Shape" class="space">
										<i class="glyphicon glyphicon-pencil"></i> 
									</a>
									{!! Form::open(array('id'=>'destroyShape'.$key->id,'method' => 'DELETE','class'=>'delete-icon', 'route' => array('shapes.destroy', $key->id))) !!}
				  ...
				  {!! $shapes->appends(Request::except('page'))->render() !!}
