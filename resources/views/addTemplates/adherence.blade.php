                     ...
                     <div class="form-wrapper row">
                        <div class="col-lg-4 col-md-4">
                           <div class="form-group">
                              ...
                              {!! Form::select('knowledge',$data['adherence'],'Yes',['id'=>'knowledge','class'=>'form-control','onchange'=>'checkAdherence()']) !!}
                        ...
                        <div class="col-lg-4 col-md-4">
                           <div class="form-group">
                              ...
                              {!! Form::select('securityVerification',$data['adherence'],'Yes',['id'=>'securityVerification','class'=>'form-control','onchange'=>'checkAdherence()']) !!}
                        ...
                        <div class="col-lg-4 col-md-4">
                           <div class="form-group">
                              ...
                              {!! Form::select('callBackSeverity',$data['adherence'],'Yes',['id'=>'callBackSeverity','class'=>'form-control','onchange'=>'checkAdherence()']) !!}
                        ...
                        <div class="col-lg-4 col-md-4">
                           <div class="form-group">
                              ...
                              {!! Form::select('adherenceOther',$data['adherence'],'NA',['id'=>'adherenceOther','class'=>'form-control','onchange'=>'checkAdherence()']) !!}
