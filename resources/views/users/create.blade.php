		...
		<div class="row">
			<div class="col-xs-12">
				<section id="inputDetail" class="form-container">
					{!! Form::open(['route' => 'users.store' , 'onSubmit' => 'return validateUser()']) !!}
						<div class="form-control-wrapper">
							<div class="form-group">
								<div class="row">
									<div class="col-sm-4"> 						
										{!! HTML::decode(Form::label('unit', 'Unit <small class="mandatory">*</small>')) !!}						
										{!! Form::select('unit', $data['unit'], null, ['id'=>'unit','class'=>'form-control']) !!}
										<div id="unit_alert" class="error validationAlert validationError">{!!$errors->first('unit')!!}</div>
									</div>
									<div class="col-sm-4"> 						
										{!! HTML::decode(Form::label('firstname', 'First Name <small class="mandatory">*</small>')) !!}
										{!! Form::text('firstname','',array("placeholder"=>"First Name",'id'=>'firstname','class'=>'form-control','maxlength'=>15,'autocomplete'=>'off')) !!} 
										<div id="firstname_alert" class="error validationAlert validationError">{!!$errors->first('firstname')!!}</div>
									</div>
									<div class="col-sm-4"> 						
										{!! HTML::decode(Form::label('lastname', 'Last Name <small class="mandatory">*</small>')) !!}
										{!! Form::text('lastname','',array("placeholder"=>"Last Name",'id'=>'lastname','class'=>'form-control','maxlength'=>15,'autocomplete'=>'off')) !!} 
										<div id="lastname_alert" class="error validationAlert validationError">{!!$errors->first('lastname')!!}</div>
									</div>
								</div>
							</div>	
							<div class="form-group">
								<div class="row">
									<div class="col-sm-4"> 
										...
										{!! Form::email('email', '', ["placeholder"=>"Email Address",'id'=>'email','class'=>'form-control']) !!}
									...
									<div class="col-sm-4"> 						
										...
										{!! Form::text('username','',array("placeholder"=>"Username",'id'=>'username','class'=>'form-control','maxlength'=>15,'autocomplete'=>'off')) !!} 
									...
									<div class="col-sm-4"> 						
										...
										{!! Form::password('password',array('placeholder'=>'Password','id'=>'password','class'=>'form-control','maxlength'=>15)) !!} 
							...
							<div class="form-group">
								<div class="row">
									<div class="col-sm-4"> 						
										...
										{!! Form::select('role',$data['role'], null, ['id'=>'role','class'=>'form-control']) !!}
